...
const Projects = ()=>{
    return(
        <div id="skill" className="max-w-[1040px] mt-24 text-center md:pl-20 py-16 ml-44 max-md:mx-8">
          ...
          <div className=" items-center lg:flex justify-between gap-4">
               ...
               <p className="py-2 text-gray-400">Full-Stack Developer proficient in developing cutting-edge solutions. Skilled in front-end  development.</p>
                <p className="py-2 text-gray-400">PHP</p>
                <p className="py-2 text-gray-400">Node.js, Express.js</p>
                <p className="py-2 text-gray-400">MYSql</p>
               </div>
               <div>
